...
<html lang="es">
    <head>
        ...
        <meta name="description" content="LMS system">
        <meta name="author" content="Andean Technologies S.A.C.">
        <title>
        ...
        <div id="wrapper">
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                    ...
                    <div class="sidebar-brand-text mx-3">Capacitación</div>
                </a>
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">
                            ...
                            <span><g:message code="messages" /></span>
                        </a>
                    </li>
                    <hr class="sidebar-divider">
                    <div class="sidebar-heading">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">
                            ...
                            <span><g:message code="courses.my" /></span>
                        </a>
                    </li>
                    <hr class="sidebar-divider">
                    <div class="sidebar-heading">
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright &copy; Andean Technologies S.A.C. 2019</span>
                        </div>
                    </div>
                </footer>
            </div>
